...
import { getUsdt, getElyfi, getUsdc } from '../utils/getDependencies';
import { usdcReserveData, usdtReserveData } from '../data/moneyPool/reserves';

const deploy: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  const admin = hre.ethers.provider.getSigner('0x715B006d4723977CcDb1581a62948f6354752e62');
