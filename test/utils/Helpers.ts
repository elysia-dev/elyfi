...
export async function getUserData({
  ...
  return {
    ...
    principleDTokenBalance: contractUserData.principleDTokenBalance,
...
export async function getReserveData({
  ...
  return {
    ...
    principleDTokenSupply: contractReserveData.principleDTokenSupply,
...
export async function getAssetBondData({
  ...
  return {
    ...
    principle: contractAssetBondData.principle,
